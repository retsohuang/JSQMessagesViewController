 ...
 */
- (void)messagesCollectionViewCellDidTapAvatar:(nonnull JSQMessagesCollectionViewCell *)cell;
 ...
 *  @param cell The cell that received the tap touch event.
 */
- (void)messagesCollectionViewCellDidTapMessageBubble:(nonnull JSQMessagesCollectionViewCell *)cell;
 ...
 */
- (void)messagesCollectionViewCellDidTapCell:(nonnull JSQMessagesCollectionViewCell *)cell atPosition:(CGPoint)position;
